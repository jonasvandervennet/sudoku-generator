...
def makelist(iterable, verbose=False):
    sudokulist = []
    for i in iterable:
        sudokulist.append(Sudoku(size=i * i, verbose=verbose).solve())
...
sp = SudokuPuzzle(size=9, verbose=False, custom=custom_scoring)
print(sp.original)
print(sp.solution)
print(sp.difficulty, sp.calculation_time)
